...
class Admin::RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post rewards_url, params: { reward: { description: @reward.description, name: @reward.name, rate: @reward.rate } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { description: @reward.description, name: @reward.name, rate: @reward.rate } }
