...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { reward_id: @result.reward_id, user_id: @result.user_id } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { reward_id: @result.reward_id, user_id: @result.user_id } }
